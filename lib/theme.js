...
let baseDir = path.dirname(require.main.filename) + _genericPath(config.path.base)
baseDir += require.main.filename.includes(config.regex.insiders) ? _genericPath(config.path.insiders) : ""
